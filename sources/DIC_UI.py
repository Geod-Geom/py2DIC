...
class Form(QDialog):
    ...
    def button_click(self):
		try:
			...
			print "Errore: gli input devono essere un numero"
		...
		try:  
			...
			print "Errore durante il calcolo della crosscorrelazione"
			self.display.setText(self.display.toPlainText()+"Errore durante il calcolo della crosscorrelazione\n")
